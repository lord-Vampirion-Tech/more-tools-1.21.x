...
public class ModItems {
    ...
    public static final Item STONE_OMNI_TOOL    = registerItem("stone_omni_tool",   new ModOmniToolItem (materialTool(ToolMaterials.STONE,3.5f, 1.0f),5.0F,-2.8F, ModTags.Blocks.MULTI_TOOL_MINEABLE,
            new Item.Settings()), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.STONE_HOE});
    ...
    public static final Item IRON_BIG_OMNI_TOOL     = registerItem("iron_big_omni_tool",    new ModBigOmniToolItem (materialTool(ToolMaterials.IRON,4.0f, 2.0f),6.0F,-3.0F, ModTags.Blocks.MULTI_TOOL_MINEABLE,
            toolSettings(1,0)), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.IRON_HOE});
    public static final Item IRON_OMNI_TOOL         = registerItem("iron_omni_tool",        new ModOmniToolItem    (materialTool(ToolMaterials.IRON,3.5f, 1.0f),5.0F,-2.0F, ModTags.Blocks.MULTI_TOOL_MINEABLE,
            new Item.Settings()), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.IRON_HOE});
    ...
    public static final Item GOLDEN_BIG_SHOVEL_LVL_2  = registerItem("golden_big_shovel_lvl_2", new ModShovelItem      (materialTool(ToolMaterials.GOLD,3.0f, 3.0f),1.0F,-1.8F,  BlockTags.SHOVEL_MINEABLE, toolSettings(2, 2)));
    public static final Item GOLDEN_CLEAVER_LVL_2     = registerItem("golden_cleaver_lvl_2",    new ModCleaverItem     (materialTool(ToolMaterials.GOLD,3.0f, 3.0f),9.0F,-2.5F,  BlockTags.AXE_MINEABLE, toolSettings(2, 2)));
    public static final Item GOLDEN_HAMMER_LVL_2      = registerItem("golden_hammer_lvl_2",     new ModHammerItem      (materialTool(ToolMaterials.GOLD,3.0f, 3.0f),3.0F,-1.8F,  BlockTags.PICKAXE_MINEABLE, toolSettings(2, 2)));
    public static final Item GOLDEN_BIG_HOE_LVL_2     = registerItem("golden_big_hoe_lvl_2",    new ModHoeItem         (materialTool(ToolMaterials.GOLD,3.0f, 3.0f),1.0F,-0.5F,  BlockTags.HOE_MINEABLE, toolSettings(2, 2)));
    ...
    public static final Item GOLDEN_BIG_OMNI_TOOL     = registerItem("golden_big_omni_tool",    new ModBigOmniToolItem (materialTool(ToolMaterials.GOLD,4.0f, 2.0f),6.0F,-3.0F,  ModTags.Blocks.MULTI_TOOL_MINEABLE,
            toolSettings(1,0)), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.GOLDEN_HOE});
    public static final Item GOLDEN_OMNI_TOOL         = registerItem("golden_omni_tool",        new ModOmniToolItem (materialTool(ToolMaterials.GOLD,2.0f, 2.0f),5.0F,-2.0F,     ModTags.Blocks.MULTI_TOOL_MINEABLE,
            new Item.Settings()), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.GOLDEN_HOE});
    ...
    public static final Item DIAMOND_BIG_SHOVEL_LVL_2  = registerItem("diamond_big_shovel_lvl_2", new ModShovelItem      (materialTool(ToolMaterials.DIAMOND,4.5f, 1.5f),2.0F,-2.8F, BlockTags.SHOVEL_MINEABLE, toolSettings(2, 2)));
    public static final Item DIAMOND_CLEAVER_LVL_2     = registerItem("diamond_cleaver_lvl_2",    new ModCleaverItem     (materialTool(ToolMaterials.DIAMOND,4.5f, 1.5f),8.0F,-3.7F, BlockTags.AXE_MINEABLE, toolSettings(2, 2)));
    public static final Item DIAMOND_HAMMER_LVL_2      = registerItem("diamond_hammer_lvl_2",     new ModHammerItem      (materialTool(ToolMaterials.DIAMOND,4.5f, 1.5f),2.0F,-2.8F, BlockTags.PICKAXE_MINEABLE, toolSettings(2, 2)));
    public static final Item DIAMOND_BIG_HOE_LVL_2     = registerItem("diamond_big_hoe_lvl_2",    new ModHoeItem         (materialTool(ToolMaterials.DIAMOND,4.5f, 1.5f),-1.0F,0.0F, BlockTags.HOE_MINEABLE, toolSettings(2, 2)));
    ...
    public static final Item DIAMOND_BIG_OMNI_TOOL     = registerItem("diamond_big_omni_tool",    new ModBigOmniToolItem (materialTool(ToolMaterials.DIAMOND,4.0f, 2.0f),6.0F,-3.0F,    ModTags.Blocks.MULTI_TOOL_MINEABLE,
            toolSettings(1,0)), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.DIAMOND_HOE});
    public static final Item DIAMOND_OMNI_TOOL         = registerItem("diamond_omni_tool",        new ModOmniToolItem    (materialTool(ToolMaterials.DIAMOND,3.5f, 1.0f),5.0F,-2.0F, ModTags.Blocks.MULTI_TOOL_MINEABLE,
            new Item.Settings()), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.DIAMOND_HOE});
    ...
    public static final Item NETHERITE_BIG_OMNI_TOOL     = registerItem("netherite_big_omni_tool",    new ModBigOmniToolItem (materialTool(ToolMaterials.NETHERITE,4.0f, 2.0f),6.0F,-3.0F,      ModTags.Blocks.MULTI_TOOL_MINEABLE,
            toolSettings(1,0)), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.NETHERITE_HOE});
    public static final Item NETHERITE_OMNI_TOOL         = registerItem("netherite_omni_tool",        new ModOmniToolItem    (materialTool(ToolMaterials.NETHERITE,3.5f, 1.0f),5.0F,-2.0F, ModTags.Blocks.MULTI_TOOL_MINEABLE,
            new Item.Settings()), new RegistryKey[]{ItemGroups.TOOLS}, new Item[]{Items.NETHERITE_HOE});

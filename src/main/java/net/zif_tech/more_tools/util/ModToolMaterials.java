...
public class ModToolMaterials implements ToolMaterial {
    ...
    public ModToolMaterials(ToolMaterial baseMaterial, float customDurability, float customMiningSpeed, float customAttackDamage) {
    ...
    public static ToolMaterial CUSTOM(ToolMaterial toolMaterials, float durability, float miningSpeed, float attackDamage) {
        return new ModToolMaterials(toolMaterials, toolMaterials.getDurability() * durability, toolMaterials.getMiningSpeedMultiplier() + miningSpeed, attackDamage);
    }
